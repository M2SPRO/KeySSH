...
wget https://raw.githubusercontent.com/M2SPRO/SCRIPT/main/Modulos/list > /dev/null 2>&1
wget https://raw.githubusercontent.com/M2SPRO/SCRIPT/main/Modulos/versao -O /bin/versao > /dev/null 2>&1
wget https://raw.githubusercontent.com/M2SPRO/SCRIPT/main/Modulos/licence -O /usr/lib/licence > /dev/null 2>&1
clear
